...
// http://www.openmicroscopy.org/site/support/bio-formats5.1/_downloads/FileExport.java
// http://www.openmicroscopy.org/site/support/bio-formats5.1/developers/export2.html
/*
 * http://www.programcreek.com/java-api-examples/index.php?class=loci.formats.services.OMEXMLService&method=getOMEXML
 * http://www.programcreek.com/java-api-examples/index.php?source_dir=mitobo-master/src/main/java/de/unihalle/informatik/MiToBo/io/images/ImageReaderMTB.java
 * http://www.programcreek.com/java-api-examples/index.php?api=loci.formats.ImageReader
 ...
 * https://github.com/openmicroscopy/bioformats/blob/develop/components/formats-gpl/utils/EditImageName.java
 * http://www.openmicroscopy.org/site/support/bio-formats5.1/developers/export2.html
 * #%L
...
public class FileExport {
  ...
  public static void main(String[] args) throws Exception {
	File file = new File("/home/mwm1/Work/biogrid/1/p3_6_1_015.ome.tiff");
	file.delete();
    FileExport exporter = new FileExport(file.getAbsolutePath());
    exporter.export();
